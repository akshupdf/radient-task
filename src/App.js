...
function App() {
  ...
  <div>
      ...
      <main className="main">
      <div >
          <p className="title">Best Website Builders in the US</p>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M14.6084 7.21285C14.8525 7.44408 14.8525 7.81899 14.6084 8.05022L9.60845 12.787C9.36437 13.0183 8.96864 13.0183 8.72456 12.787L6.22456 10.4186C5.98048 10.1874 5.98048 9.81251 6.22456 9.58127C6.46864 9.35004 6.86437 9.35004 7.10845 9.58127L9.16651 11.531L13.7246 7.21285C13.9686 6.98162 14.3644 6.98162 14.6084 7.21285Z" fill="#626E79"/>
        ...
        <p style={{marginLeft : '5px'}}> Last Updated - February 22, 2020</p>
        
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginLeft : '15px'}}>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.2002 14.1666C8.2002 13.8215 8.46884 13.5416 8.8002 13.5416H11.6002C11.9316 13.5416 12.2002 13.8215 12.2002 14.1666C12.2002 14.5118 11.9316 14.7916 11.6002 14.7916H8.8002C8.46884 14.7916 8.2002 14.5118 8.2002 14.1666Z" fill="#626E79"/>
        ...
        <p style={{ marginLeft : '5px'}}> Advertising Disclosure</p>
        
        </div>


        <div style={{display: 'flex' , marginRight : '0px'}}>
        <p style={{ marginLeft : '5px'}}> Top Relevant</p>
